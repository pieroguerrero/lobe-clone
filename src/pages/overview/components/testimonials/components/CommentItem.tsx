...
export default function CommentItem({
  ...
  return (
    <div className="flex h-[430px] w-[292px] flex-col justify-between rounded-[32px] bg-color-quaternary p-6 antialiased shadow-lg duration-200 hover:scale-105 hover:duration-200 sm:h-[506px] sm:w-[336px] sm:p-8 2xl:h-[580px]  2xl:w-[435px] 2xl:p-12">
